...
import kotlinx.android.synthetic.main.dialog_add_salary.*


class AddSalaryDailog(context: Context) : BlurDialogFragment(), LifecycleOwner {
    ...
    companion object {
        ...
        fun newInstance(
            ...
            return AddSalaryDailog(context)
        }
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.dialog_add_salary, container, false)
    }
